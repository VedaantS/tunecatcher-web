    ...
    <div className=' text-white max-w-[220px] '>
        <details open className='text-white detailanimatation'>
            ...
            <div>
                ...
                <button onClick={() => setShow(true)} className='text-xs group font-semibold mb-7 flex gap-2 border-[1.5px] border-white rounded-lg px-2 items-center py-2'><FaPlus className=' group-hover:text-[#e8871e]'/>Create</button>
                </div>
                </div>
        </details>       
