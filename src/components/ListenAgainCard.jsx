    ...
    <div>
         <div
            onClick={() => {
             ...
             className={`flex w-40 md:w-80 items-center mt-5 cursor-pointer group border-b-[1px] border-gray-400 justify-between ${activeSong?.id === song?.id && " text-[#e8871e]"}`}>
              ...
              <div className=" relative mb-2">
                ...
                />
                {
                  activeSong?.id === song?.id ? (
                    <BiHeadphone size={27} className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[#e8871e]" />
                  ) : (
                    <BsPlayFill
                    size={25}
