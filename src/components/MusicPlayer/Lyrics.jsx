    ...
    return (
        <div onClick={(e) => { e.stopPropagation(); }} >
            <div className='flex justify-center items-center w-full'>
                <button onClick={() => { setActiveTab('queue') }} className={`${activeTab === 'queue' ? 'border-[#e8871e] border-b-2' : ''} text-white text-xl m-3 mt-20 sm:mt-0 font-medium `}>Queue</button>
                <button onClick={() => { setActiveTab('lyrics') }} className={`${activeTab === 'lyrics' ? 'border-[#e8871e] border-b-2' : ''} text-white text-xl m-3 mt-20 sm:mt-0  font-medium`}>Lyrics</button>
            </div>
            <div>
                {activeTab === 'lyrics' ? (
