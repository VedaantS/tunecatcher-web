            ...
            <div className=" flex justify-center items-center">
                <div className="container flex justify-center flex-col items-center w-[90vw] lg:w-1/2">
                    ...
                    <form onSubmit={handelSubmit} className="text-white flex flex-col text-base lg:text-xl gap-2 font-medium">
                        ...
                        <p className=' text-xs text-[#e8871e]'>Forgot Password?</p>
                        </Link>
                        ...
                        <div className=" w-full flex justify-center">
                            <button onClick={() => signIn('google')} type='button' className="flex items-center gap-[.7px] hover:border-[#e8871e] justify-center px-4 py-2 group font-medium border-2 border-white rounded-sm">
                                <FaGoogle className=" group-hover:text-[#e8871e]"/>oogle
                            </button>
                        </div>
